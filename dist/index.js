...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (yield packageVersionExists(name, version)) {
...
function getPackageJSON() {
    ...
    const pathToPackage = (0, path_1.join)(GITHUB_WORKSPACE, 'package.json');
...
function packageVersionExists(name, version) {
    return __awaiter(this, void 0, void 0, function* () {
        const res = yield (0, cross_fetch_1.fetch)(`https://registry.npmjs.org/${name}/${version}`).catch((err) => err instanceof Error ? err : new Error(JSON.stringify(err)));
        if (res instanceof Error || res.status === 404) {
            return false;
        }
        const json = yield res
            .json()
